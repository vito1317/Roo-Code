 ...
 */
export function getModelDimension(provider, modelId) {
 ...
 */
export function getModelScoreThreshold(provider, modelId) {
    const providerProfiles = EMBEDDING_MODEL_PROFILES[provider];
    if (!providerProfiles) {
        return undefined;
    }
 ...
 */
export function getModelQueryPrefix(provider, modelId) {
    const providerProfiles = EMBEDDING_MODEL_PROFILES[provider];
    if (!providerProfiles) {
        return undefined;
    }
...
//# sourceMappingURL=embeddingModels.js.map