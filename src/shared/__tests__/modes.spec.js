...
describe("isToolAllowedForMode", () => {
    ...
    describe("file restrictions", () => {
        ...
        it("applies restrictions to apply_patch (custom tool)", () => {
            ...
            expect(() => isToolAllowedForMode("apply_patch", "markdown-editor", customModes, undefined, {
                patch: "*** Begin Patch\n*** Update File: test.js\n@@ \n-old\n+new\n*** End Patch",
            }, undefined, ["apply_patch"])).toThrow(FileRestrictionError);
            expect(() => isToolAllowedForMode("apply_patch", "markdown-editor", customModes, undefined, {
                patch: "*** Begin Patch\n*** Update File: test.js\n@@ \n-old\n+new\n*** End Patch",
            }, undefined, ["apply_patch"])).toThrow(/\\.md\$/);
        });
        it("applies restrictions to search_replace (custom tool)", () => {
            // Test that search_replace respects file restrictions when included
            const searchReplaceResult = isToolAllowedForMode("search_replace", "markdown-editor", customModes, undefined, {
                file_path: "test.md",
                old_string: "old text",
                new_string: "new text",
            }, undefined, ["search_replace"]);
            expect(searchReplaceResult).toBe(true);
            // Test search_replace with non-matching file
            expect(() => isToolAllowedForMode("search_replace", "markdown-editor", customModes, undefined, {
                file_path: "test.js",
                old_string: "old text",
                new_string: "new text",
            }, undefined, ["search_replace"])).toThrow(FileRestrictionError);
            expect(() => isToolAllowedForMode("search_replace", "markdown-editor", customModes, undefined, {
                file_path: "test.js",
                old_string: "old text",
                new_string: "new text",
            }, undefined, ["search_replace"])).toThrow(/\\.md\$/);
        });
        it("applies restrictions to edit_file (custom tool)", () => {
            ...
            expect(() => isToolAllowedForMode("edit_file", "markdown-editor", customModes, undefined, {
                file_path: "test.js",
                old_string: "old text",
                new_string: "new text",
            }, undefined, ["edit_file"])).toThrow(FileRestrictionError);
            expect(() => isToolAllowedForMode("edit_file", "markdown-editor", customModes, undefined, {
                file_path: "test.js",
                old_string: "old text",
                new_string: "new text",
            }, undefined, ["edit_file"])).toThrow(/\\.md\$/);
        });
        it("applies restrictions to all editing tools in architect mode (custom tools)", () => {
            // Test apply_patch in architect mode
            // Note: apply_patch only accepts { patch: string } - file paths are embedded in patch content
            expect(isToolAllowedForMode("apply_patch", "architect", [], undefined, {
                patch: "*** Begin Patch\n*** Update File: test.md\n@@ \n-old\n+new\n*** End Patch",
            }, undefined, ["apply_patch"])).toBe(true);
            expect(() => isToolAllowedForMode("apply_patch", "architect", [], undefined, {
                patch: "*** Begin Patch\n*** Update File: test.js\n@@ \n-old\n+new\n*** End Patch",
            }, undefined, ["apply_patch"])).toThrow(FileRestrictionError);
            // Test search_replace in architect mode
            expect(isToolAllowedForMode("search_replace", "architect", [], undefined, {
                file_path: "test.md",
                old_string: "old text",
                new_string: "new text",
            }, undefined, ["search_replace"])).toBe(true);
            expect(() => isToolAllowedForMode("search_replace", "architect", [], undefined, {
                file_path: "test.js",
                old_string: "old text",
                new_string: "new text",
            ...
            expect(isToolAllowedForMode("edit_file", "architect", [], undefined, {
                file_path: "test.md",
                old_string: "old text",
                new_string: "new text",
            }, undefined, ["edit_file"])).toBe(true);
            expect(() => isToolAllowedForMode("edit_file", "architect", [], undefined, {
                file_path: "test.js",
                old_string: "old text",
                new_string: "new text",
    ...
    describe("customTools (opt-in tools)", () => {
        ...
        it("disallows customTools by default (not in includedTools)", () => {
            ...
            expect(isToolAllowedForMode("search_and_replace", "test-custom-tools", customModesWithEditGroup)).toBe(false);
        });
        it("allows customTools when included in includedTools", () => {
            // search_and_replace should be allowed when explicitly included
            expect(isToolAllowedForMode("search_and_replace", "test-custom-tools", customModesWithEditGroup, undefined, undefined, undefined, ["search_and_replace"])).toBe(true);
        });
        it("disallows customTools even in includedTools if mode doesn't have the group", () => {
            ...
            expect(isToolAllowedForMode("search_and_replace", "no-edit-mode", customModesWithoutEdit, undefined, undefined, undefined, ["search_and_replace"])).toBe(false);
        });
