...
import { IMAGE_GENERATION_MODEL_IDS, IMAGE_GENERATION_MODELS, getImageGenerationProvider, } from "@roo-code/types";
...
export class GenerateImageTool extends BaseTool {
    ...
    async execute(params, task, callbacks) {
        ...
        const imageProvider = getImageGenerationProvider(state?.imageGenerationProvider, !!state?.openRouterImageGenerationSelectedModel);
        ...
        try {
            ...
            if (modelProvider === "roo") {
                ...
                const rooHandler = new RooHandler({});
