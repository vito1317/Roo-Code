 ...
 */
export async function readImageAsDataUrlWithBuffer(filePath) {
 ...
 */
export function isSupportedImageFormat(extension) {
 ...
 */
export async function validateImageForProcessing(fullPath, supportsImages, maxImageFileSize, maxTotalImageSize, currentTotalMemoryUsed) {
 ...
 */
export async function processImageFile(fullPath) {
    const imageStats = await fs.stat(fullPath);
