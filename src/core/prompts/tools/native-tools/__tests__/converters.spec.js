...
import { convertOpenAIToolToAnthropic, convertOpenAIToolsToAnthropic, convertOpenAIToolChoiceToAnthropic, } from "../converters";
describe("converters", () => {
    ...
    describe("convertOpenAIToolChoiceToAnthropic", () => {
        ...
        it("should return auto for unknown string tool choice", () => {
            const result = convertOpenAIToolChoiceToAnthropic("unknown");
            expect(result).toEqual({ type: "auto", disable_parallel_tool_use: true });
        });
        ...
        it("should return auto for object without function property", () => {
            const result = convertOpenAIToolChoiceToAnthropic({ type: "something" });
            expect(result).toEqual({ type: "auto", disable_parallel_tool_use: true });
        });
    });
});
