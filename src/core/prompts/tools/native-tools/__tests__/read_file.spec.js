...
describe("createReadFileTool", () => {
    ...
    describe("supportsImages option", () => {
        it("should include image format documentation when supportsImages is true", () => {
            ...
            const description = getFunctionDef(tool).description;
            expect(description).toContain("Automatically processes and returns image files (PNG, JPG, JPEG, GIF, BMP, SVG, WEBP, ICO, AVIF) for visual analysis");
        });
        it("should not include image format documentation when supportsImages is false", () => {
            ...
            const description = getFunctionDef(tool).description;
            expect(description).not.toContain("Automatically processes and returns image files (PNG, JPG, JPEG, GIF, BMP, SVG, WEBP, ICO, AVIF) for visual analysis");
        ...
        it("should always include PDF and DOCX support in description", () => {
            ...
            expect(getFunctionDef(toolWithImages).description).toContain("Supports text extraction from PDF and DOCX files");
            expect(getFunctionDef(toolWithoutImages).description).toContain("Supports text extraction from PDF and DOCX files");
        });
    });
...
//# sourceMappingURL=read_file.spec.js.map