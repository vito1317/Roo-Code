...
describe("SYSTEM_PROMPT", () => {
    ...
    it("should include browser actions when supportsImages is true", async () => {
        const prompt = await SYSTEM_PROMPT(mockContext, "/test/path", true, // supportsImages
        undefined, // mcpHub
        undefined, // diffStrategy
    ...
    it("should include MCP server info when mcpHub is provided", async () => {
        ...
        const prompt = await SYSTEM_PROMPT(mockContext, "/test/path", false, mockMcpHub, // mcpHub
        undefined, // diffStrategy
        undefined, // browserViewportSize
        defaultModeSlug, // mode
        undefined, // customModePrompts
    ...
    it("should explicitly handle undefined mcpHub", async () => {
        const prompt = await SYSTEM_PROMPT(mockContext, "/test/path", false, undefined, // explicitly undefined mcpHub
        undefined, // diffStrategy
        undefined, // browserViewportSize
        defaultModeSlug, // mode
        undefined, // customModePrompts
