...
describe("loadRuleFiles", () => {
    ...
    it("should use .roo/rules/ directory when it exists and has files", async () => {
        ...
        statMock.mockImplementation((path) => {
            ...
            if (normalizedPath.includes("/fake/path/.roo/rules/file1.txt") ||
        ...
        const expectedFile1Path = process.platform === "win32" ? "\\fake\\path\\.roo\\rules\\file1.txt" : "/fake/path/.roo/rules/file1.txt";
        const expectedFile2Path = process.platform === "win32" ? "\\fake\\path\\.roo\\rules\\file2.txt" : "/fake/path/.roo/rules/file2.txt";
    ...
    it("should read files from nested subdirectories in .roo/rules/", async () => {
        ...
        const expectedRelativeNested1Path = process.platform === "win32" ? ".roo\\rules\\subdir\\nested1.txt" : ".roo/rules/subdir/nested1.txt";
        const expectedRelativeNested2Path = process.platform === "win32"
        ...
        const expectedRootPath2 = process.platform === "win32" ? "\\fake\\path\\.roo\\rules\\root.txt" : "/fake/path/.roo/rules/root.txt";
...
describe("addCustomInstructions", () => {
    ...
    it("should use .roo/rules-test-mode/ directory when it exists and has files", async () => {
        ...
        statMock.mockImplementation((path) => {
            // Handle both Unix and Windows path separators
            const normalizedPath = path.toString().replace(/\\/g, "/");
            if (normalizedPath.includes("/fake/path/.roo/rules-test-mode/rule1.txt") ||
        ...
        const expectedRelativeRule1Path = process.platform === "win32" ? ".roo\\rules-test-mode\\rule1.txt" : ".roo/rules-test-mode/rule1.txt";
        const expectedRelativeRule2Path = process.platform === "win32" ? ".roo\\rules-test-mode\\rule2.txt" : ".roo/rules-test-mode/rule2.txt";
        ...
        const expectedAbsTestModeDir = process.platform === "win32" ? "\\fake\\path\\.roo\\rules-test-mode" : "/fake/path/.roo/rules-test-mode";
        const expectedAbsRule1Path = process.platform === "win32"
            ? "\\fake\\path\\.roo\\rules-test-mode\\rule1.txt"
            : "/fake/path/.roo/rules-test-mode/rule1.txt";
        const expectedAbsRule2Path = process.platform === "win32"
...
describe("Rules directory reading", () => {
    it.skipIf(process.platform === "win32")("should follow symbolic links in the rules directory", async () => {
        ...
        const expectedRelativeRegularPath = process.platform === "win32" ? ".roo\\rules\\regular.txt" : ".roo/rules/regular.txt";
        const expectedRelativeSymlinkPath = process.platform === "win32" ? ".roo\\symlink-target.txt" : ".roo/symlink-target.txt";
        const expectedRelativeSubdirPath = process.platform === "win32"
            ? ".roo\\rules\\symlink-target-dir\\subdir_link.txt"
            : ".roo/rules/symlink-target-dir/subdir_link.txt";
        const expectedRelativeNestedPath = process.platform === "win32" ? ".roo\\nested-symlink-target.txt" : ".roo/nested-symlink-target.txt";
    ...
    it.skipIf(process.platform === "win32")("should correctly format multiple files from directory", async () => {
        ...
        const result = await loadRuleFiles("/fake/path");
        // Paths in output should be relative
        const expectedRelativeFile1Path = process.platform === "win32" ? ".roo\\rules\\file1.txt" : ".roo/rules/file1.txt";
        const expectedRelativeFile2Path = process.platform === "win32" ? ".roo\\rules\\file2.txt" : ".roo/rules/file2.txt";
        const expectedRelativeFile3Path = process.platform === "win32" ? ".roo\\rules\\file3.txt" : ".roo/rules/file3.txt";
    ...
    it("should return files in alphabetical order by filename", async () => {
        ...
        const expectedRelativeAlphaPath = process.platform === "win32" ? ".roo\\rules\\alpha.txt" : ".roo/rules/alpha.txt";
        const expectedRelativeBetaPath = process.platform === "win32" ? ".roo\\rules\\Beta.txt" : ".roo/rules/Beta.txt";
        const expectedRelativeZebraPath = process.platform === "win32" ? ".roo\\rules\\zebra.txt" : ".roo/rules/zebra.txt";
