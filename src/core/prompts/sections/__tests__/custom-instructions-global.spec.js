...
const { mockHomedir, mockStat, mockReadFile, mockReaddir, mockLstat, mockGetRooDirectoriesForCwd, mockGetAllRooDirectoriesForCwd, mockGetAgentsDirectoriesForCwd, mockGetGlobalRooDirectory, } = vi.hoisted(() => ({
    mockHomedir: vi.fn(),
    mockStat: vi.fn(),
    mockReadFile: vi.fn(),
    mockReaddir: vi.fn(),
