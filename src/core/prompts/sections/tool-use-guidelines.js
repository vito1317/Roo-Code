...
export function getToolUseGuidelinesSection(experimentFlags) {
    // Build guidelines array with automatic numbering
    let itemNumber = 1;
    const guidelinesList = [];
    // First guideline is always the same
    guidelinesList.push(`${itemNumber++}. Assess what information you already have and what information you need to proceed with the task.`);
    ...
    const isMultipleNativeToolCallsEnabled = experiments.isEnabled(experimentFlags ?? {}, EXPERIMENT_IDS.MULTIPLE_NATIVE_TOOL_CALLS);
