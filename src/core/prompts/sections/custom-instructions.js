...
import { getRooDirectoriesForCwd, getAllRooDirectoriesForCwd, getAgentsDirectoriesForCwd, } from "../../../services/roo-config";
/**
 ...
 */
export async function loadRuleFiles(cwd, enableSubfolderRules = false) {
    const rules = [];
