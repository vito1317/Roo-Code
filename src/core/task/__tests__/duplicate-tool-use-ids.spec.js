...
describe("Duplicate tool_use ID Prevention", () => {
    describe("Pre-flight deduplication logic", () => {
        ...
        const deduplicateToolUseBlocks = (assistantMessageContent) => {
            ...
            const result = [];
            const toolUseBlocks = assistantMessageContent.filter((block) => block.type === "tool_use" || block.type === "mcp_tool_use");
...
//# sourceMappingURL=duplicate-tool-use-ids.spec.js.map