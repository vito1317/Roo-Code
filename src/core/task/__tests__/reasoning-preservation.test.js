...
describe("Task reasoning preservation", () => {
    ...
    it("should append reasoning to assistant message when preserveReasoning is true", async () => {
        ...
        expect(task.apiConversationHistory[0].content[0].text).toContain("Let me think about this step by step. First, I need to...");
    });
...
//# sourceMappingURL=reasoning-preservation.test.js.map