...
>>>>>>> REPLACE`;
        ...
        it("should match content with smart quotes", async () => {
            const originalContent = "**Enjoy Roo Code!** Whether you keep it on a short leash or let it roam autonomously, we can't wait to see what you build. If you have questions or feature ideas, drop by our [Reddit community](https://www.reddit.com/r/RooCode/) or [Discord](https://discord.gg/roocode). Happy coding!";
            const diffContent = `test.ts
<<<<<<< SEARCH
...
>>>>>>> REPLACE`;
            ...
            expect(result.success).toBe(true);
            if (result.success) {
                expect(result.content).toBe("**Enjoy Roo Code!** Whether you keep it on a short leash or let it roam autonomously, we can't wait to see what you build. If you have questions or feature ideas, drop by our [Reddit community](https://www.reddit.com/r/RooCode/) or [Discord](https://discord.gg/roocode). Happy coding!\n\nYou're still here?");
            }
        });
...
>>>>>>> REPLACE`;
    ...
    describe("line marker validation in REPLACE sections", () => {
        ...
        it("should reject start_line marker in REPLACE section", () => {
            ...
            expect(result.error).toContain("Line markers (:start_line: and :end_line:) are only allowed in SEARCH sections");
        });
...
//# sourceMappingURL=multi-search-replace.spec.js.map