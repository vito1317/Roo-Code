...
describe("importExport", () => {
    ...
    describe("importSettings", () => {
        ...
        describe("lenient import with invalid providers", () => {
            ...
            it("should show warning notification when importing with warnings via importSettingsWithFeedback", async () => {
                ...
                expect(showWarningMessageSpy).toHaveBeenCalledWith(expect.stringContaining("1 profile had issues during import."));
                expect(showWarningMessageSpy).toHaveBeenCalledWith(expect.stringContaining("See Developer Tools console for details."));
                // Should log full details to console
                expect(consoleWarnSpy).toHaveBeenCalledWith("Settings import completed with warnings:", expect.arrayContaining([expect.stringContaining("problematic-profile")]));
            ...
            it("should fallback currentApiConfigName when the imported current profile was skipped", async () => {
                ...
                expect(warnings.some((w) => w.includes("invalid-current-profile") &&
                    w.includes("not available") &&
                    w.includes("valid-fallback-profile"))).toBe(true);
            ...
            it("should show plural summary for multiple profile warnings via importSettingsWithFeedback", async () => {
                ...
                expect(showWarningMessageSpy).toHaveBeenCalledWith(expect.stringContaining("2 profiles had issues during import."));
                // Should log full details to console
                expect(consoleWarnSpy).toHaveBeenCalledWith("Settings import completed with warnings:", expect.arrayContaining([
    ...
    describe("exportSettings", () => {
        ...
        ])("should exclude modelMaxTokens and modelMaxThinkingTokens when $testCase", async ({ providerName, modelId, providerId }) => {
