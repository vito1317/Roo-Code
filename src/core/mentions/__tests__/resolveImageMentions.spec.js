...
vi.mock("../../tools/helpers/imageHelpers", () => ({
    isSupportedImageFormat: vi.fn((ext) => [".png", ".jpg", ".jpeg", ".gif", ".webp", ".svg", ".bmp", ".ico", ".tiff", ".tif", ".avif"].includes(ext.toLowerCase())),
...
//# sourceMappingURL=resolveImageMentions.spec.js.map