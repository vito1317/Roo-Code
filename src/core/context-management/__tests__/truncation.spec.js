...
describe("Non-Destructive Sliding Window Truncation", () => {
    ...
    describe("Rewind past truncation integration", () => {
        ...
        it("should handle multiple truncations correctly", () => {
            ...
            const firstMarker = secondTruncation.messages.find((msg) => msg.isTruncationMarker && msg.truncationId === firstTruncation.truncationId);
            const secondMarker = secondTruncation.messages.find((msg) => msg.isTruncationMarker && msg.truncationId === secondTruncation.truncationId);
        ...
        it("should handle rewinding when second truncation affects first truncation marker", () => {
            ...
            const secondMarkerIndex = secondTruncation.messages.findIndex((msg) => msg.isTruncationMarker && msg.truncationId === secondTruncation.truncationId);
            ...
            const hasSecondTruncationMarker = effective.some((msg) => msg.isTruncationMarker && msg.truncationId === secondTruncation.truncationId);
            ...
            const hasSecondTruncationParent = cleaned.some((msg) => msg.truncationParent === secondTruncation.truncationId);
...
//# sourceMappingURL=truncation.spec.js.map