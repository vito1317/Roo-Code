...
describe("presentAssistantMessage - Unknown Tool Handling", () => {
    ...
    it("should return error for unknown tool in native protocol", async () => {
        ...
        expect(mockTask.recordToolError).toHaveBeenCalledWith("nonexistent_tool", expect.stringContaining("Unknown tool"));
...
//# sourceMappingURL=presentAssistantMessage-unknown-tool.spec.js.map