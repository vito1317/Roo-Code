...
describe("getEnvironmentDetails", () => {
    ...
    beforeEach(() => {
        ...
        getGitStatus.mockResolvedValue("## main");
    ...
    it("should include Browser Session Status with current viewport when active", async () => {
        ;
        mockCline.browserSession.isSessionActive = vi.fn().mockReturnValue(true);
        mockCline.browserSession.getViewportSize = vi.fn().mockReturnValue({ width: 1280, height: 720 });
        const result = await getEnvironmentDetails(mockCline);
