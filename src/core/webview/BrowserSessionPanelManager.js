...
export class BrowserSessionPanelManager {
    ...
    async updateBrowserSession(messages, isBrowserSessionActive) {
        if (!this.panel) {
            return;
        }
    ...
    async getHMRHtmlContent(webview, extensionUri) {
        const fs = require("fs");
    ...
    getHtmlContent(webview, extensionUri) {
        const stylesUri = getUri(webview, extensionUri, ["webview-ui", "build", "assets", "index.css"]);
...
//# sourceMappingURL=BrowserSessionPanelManager.js.map