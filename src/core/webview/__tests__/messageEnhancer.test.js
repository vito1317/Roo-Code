...
describe("MessageEnhancer", () => {
    ...
    describe("enhanceMessage", () => {
        it("should enhance a simple message successfully", async () => {
            ...
            expect(mockSingleCompletionHandler).toHaveBeenCalledWith(mockApiConfiguration, expect.stringContaining("Write a function to calculate fibonacci"));
        });
    ...
    describe("extractTaskHistory", () => {
        it("should filter and format messages correctly", () => {
            ...
            const history = MessageEnhancer.extractTaskHistory(messages);
        ...
        it("should handle malformed messages gracefully", () => {
            ...
            // Access private method through any type assertion for testing
            const history = MessageEnhancer.extractTaskHistory(malformedMessages);
...
//# sourceMappingURL=messageEnhancer.test.js.map