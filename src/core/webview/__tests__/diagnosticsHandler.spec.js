...
describe("generateErrorDiagnostics", () => {
    ...
    it("generates a diagnostics file with error metadata and history", async () => {
        ...
        expect(String(writtenContent)).toContain("// Please share this file with Roo Code Support (support@roocode.com) to diagnose the issue faster");
...
//# sourceMappingURL=diagnosticsHandler.spec.js.map