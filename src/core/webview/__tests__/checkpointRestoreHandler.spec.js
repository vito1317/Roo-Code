...
describe("checkpointRestoreHandler", () => {
    ...
    beforeEach(() => {
        ...
        pWaitFor.mockImplementation(async (condition) => {
    ...
    describe("handleCheckpointRestoreOperation", () => {
        ...
        it("should handle errors gracefully", async () => {
            ...
            await expect(handleCheckpointRestoreOperation({
                provider: mockProvider,
                currentCline: mockCline,
                messageTs: 3,
                messageIndex: 2,
            ...
            expect(vscode.window.showErrorMessage).toHaveBeenCalledWith("Error during checkpoint restore: Checkpoint restore failed");
        });
    });
});
