...
describe("Telemetry Settings Tracking", () => {
    ...
    beforeEach(() => {
        ...
        vi.spyOn(TelemetryService, "instance", "get").mockReturnValue(mockTelemetryService);
    });
    describe("when telemetry is turned OFF", () => {
        it("should fire event BEFORE disabling telemetry", () => {
            ...
            expect(mockTelemetryService.captureTelemetrySettingsChanged).toHaveBeenCalledBefore(mockTelemetryService.updateTelemetryState);
    ...
    describe("when telemetry is turned ON", () => {
        it("should fire event AFTER enabling telemetry", () => {
            ...
            expect(mockTelemetryService.updateTelemetryState).toHaveBeenCalledBefore(mockTelemetryService.captureTelemetrySettingsChanged);
        });
