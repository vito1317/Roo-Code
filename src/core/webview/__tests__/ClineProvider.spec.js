...
describe("ClineProvider", () => {
    ...
    test("resolveWebviewView sets up webview correctly in development mode even if local server is not running", async () => {
        ...
        expect(mockWebviewView.webview.html).toContain("connect-src vscode-webview://test-csp-source https://openrouter.ai https://api.requesty.ai https://ph.roocode.com");
...
describe("Project MCP Settings", () => {
    ...
    test.skip("handles openProjectMcpSettings file creation error", async () => {
        ...
        // Verify error message was shown
        expect(vscode.window.showErrorMessage).toHaveBeenCalledWith(expect.stringContaining("Failed to create or open .roo/mcp.json"));
    });
});
...
describe("ClineProvider - Router Models", () => {
    ...
    test("handles requestRouterModels with successful responses", async () => {
        ...
        expect(getModels).toHaveBeenCalledWith(expect.objectContaining({
            provider: "roo",
