...
describe("Checkpoint functionality", () => {
    ...
    describe("checkpointDiff", () => {
        ...
        it("should show diff for to-current mode", async () => {
            ...
            expect(vscode.commands.executeCommand).toHaveBeenCalledWith("vscode.changes", "common:errors.checkpoint_diff_to_current", expect.any(Array));
        });
        it("should show diff for checkpoint mode with next commit", async () => {
            ...
            expect(vscode.commands.executeCommand).toHaveBeenCalledWith("vscode.changes", "common:errors.checkpoint_diff_with_next", expect.any(Array));
        });
