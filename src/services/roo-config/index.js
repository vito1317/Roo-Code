 ...
 * ```
 */
export async function discoverSubfolderRooDirectories(cwd) {
    try {
 ...
 * ```
 */
export async function getAllRooDirectoriesForCwd(cwd) {
    const directories = [];
    // Add global directory first
    directories.push(getGlobalRooDirectory());
    // Add project-local directory second
 ...
 * ```
 */
export async function getAgentsDirectoriesForCwd(cwd) {
    const directories = [];
