 ...
 */
export async function tryChromeHostUrl(chromeHostUrl) {
    try {
 ...
 * Get Docker host IP
 */
export async function getDockerHostIP() {
    try {
 ...
 */
export async function scanNetworkForChrome(baseIP, port) {
...
const discoverChromeHosts = async (port) => {
 ...
 */
export async function discoverChromeHostUrl(port = 9222) {
