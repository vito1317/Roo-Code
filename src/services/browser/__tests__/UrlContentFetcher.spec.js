...
describe("UrlContentFetcher", () => {
    ...
    describe("urlToMarkdown", () => {
        ...
        it("should throw error when ERR_ABORTED retry also fails", async () => {
            ...
            await expect(urlContentFetcher.urlToMarkdown("https://example.com")).rejects.toThrow("net::ERR_CONNECTION_REFUSED");
            expect(mockPage.goto).toHaveBeenCalledTimes(2);
        });
    });
...
//# sourceMappingURL=UrlContentFetcher.spec.js.map