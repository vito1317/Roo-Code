...
describe("parseSourceCodeDefinitionsForFile with C#", () => {
    ...
    it("should parse event declarations", () => {
        expect(parseResult).toMatch(/\d+--\d+ \|\s*public event EventHandler<TestEventArgsDefinition> TestEventDefinition/);
    });
...
//# sourceMappingURL=parseSourceCodeDefinitions.c-sharp.spec.js.map