...
describe.skip("parseSourceCodeDefinitionsForFile with Swift", () => {
    ...
    it("should capture class declarations with all modifiers", async () => {
        ...
        expect(parsedResult).toMatch(/\d+--\d+ \|\s*class InheritingClassDefinition: StandardClassDefinition, ProtocolDefinition/);
    });
...
//# sourceMappingURL=parseSourceCodeDefinitions.swift.spec.js.map