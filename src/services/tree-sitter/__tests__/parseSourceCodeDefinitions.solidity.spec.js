...
describe("Solidity Source Code Definition Tests", () => {
    ...
    it("should parse function declarations", () => {
        ...
        expect(parseResult).toMatch(/6--6 \|     function interfaceFunction\(uint256 value\) external returns \(bool\);/);
        expect(parseResult).toMatch(/12--14 \|     function add\(uint256 a, uint256 b\) internal pure returns \(uint256\) {/);
        expect(parseResult).toMatch(/16--19 \|     function subtract\(uint256 a, uint256 b\) internal pure returns \(uint256\) {/);
    });
...
//# sourceMappingURL=parseSourceCodeDefinitions.solidity.spec.js.map