...
const { mockStat, mockReadFile, mockReaddir, mockHomedir, mockDirectoryExists, mockFileExists, mockRealpath } = vi.hoisted(() => ({
    mockStat: vi.fn(),
    mockReadFile: vi.fn(),
    mockReaddir: vi.fn(),
    mockHomedir: vi.fn(),
...
describe("SkillsManager", () => {
    ...
    beforeEach(() => {
        ...
        skillsManager = new SkillsManager(mockProvider);
    });
    afterEach(async () => {
...
//# sourceMappingURL=SkillsManager.spec.js.map