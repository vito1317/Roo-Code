...
describe("hidden directory exclusion", () => {
    ...
    it("should exclude .git subdirectories from recursive directory listing", async () => {
        ...
        const hasComponentsDir = directories.some((dir) => dir.endsWith("/test/src/components/") || dir.endsWith("src/components/") || dir.includes("components/"));
    ...
    it("should allow explicit targeting of hidden directories", async () => {
        ...
        const hasContextDir = directories.some((dir) => dir.includes(".roo-memory/context/") || dir.includes("context/"));
...
//# sourceMappingURL=list-files.spec.js.map