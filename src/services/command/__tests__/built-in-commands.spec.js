...
describe("Built-in Commands", () => {
    describe("getBuiltInCommands", () => {
        ...
        it("should return commands with proper content", async () => {
            ...
            expect(initCommand.description).toBe("Analyze codebase and create concise AGENTS.md files for AI assistants");
        });
    });
...
//# sourceMappingURL=built-in-commands.spec.js.map