...
vitest.mock("../../../../i18n", () => ({
    t: (key, params) => {
        const translations = {
            ...
            "common:errors.api.invalidKeyInvalidChars": "API key contains invalid characters. Please check your API key for special characters.",
        };
    ...
    describe("constructor", () => {
        ...
        it("should handle API key with invalid characters (ByteString conversion error)", () => {
            ...
            MockedOpenAI.mockImplementationOnce(() => {
                throw new Error("Cannot convert argument to a ByteString because the character at index 7 has a value of 8226 which is greater than 255.");
            });
            expect(() => new OpenAICompatibleEmbedder(testBaseUrl, invalidApiKey, testModelId)).toThrow("API key contains invalid characters");
        });
    });
