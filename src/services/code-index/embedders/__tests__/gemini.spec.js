...
describe("GeminiEmbedder", () => {
    ...
    describe("constructor", () => {
        it("should create an instance with default model when no model specified", () => {
            ...
            // Assert
            expect(MockedOpenAICompatibleEmbedder).toHaveBeenCalledWith("https://generativelanguage.googleapis.com/v1beta/openai/", apiKey, "gemini-embedding-001", 2048);
        });
        it("should create an instance with specified model", () => {
            ...
            // Assert
            expect(MockedOpenAICompatibleEmbedder).toHaveBeenCalledWith("https://generativelanguage.googleapis.com/v1beta/openai/", apiKey, "text-embedding-004", 2048);
        });
        it("should throw error when API key is not provided", () => {
            // Act & Assert
            expect(() => new GeminiEmbedder("")).toThrow("validation.apiKeyRequired");
            expect(() => new GeminiEmbedder(null)).toThrow("validation.apiKeyRequired");
            expect(() => new GeminiEmbedder(undefined)).toThrow("validation.apiKeyRequired");
        });
    });
