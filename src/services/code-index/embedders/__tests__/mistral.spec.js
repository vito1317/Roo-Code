...
describe("MistralEmbedder", () => {
    ...
    describe("constructor", () => {
        it("should create an instance with default model when no model specified", () => {
            ...
            // Assert
            expect(MockedOpenAICompatibleEmbedder).toHaveBeenCalledWith("https://api.mistral.ai/v1", apiKey, "codestral-embed-2505", 8191);
        });
        it("should create an instance with specified model", () => {
            ...
            // Assert
            expect(MockedOpenAICompatibleEmbedder).toHaveBeenCalledWith("https://api.mistral.ai/v1", apiKey, "custom-embed-model", 8191);
        });
        it("should throw error when API key is not provided", () => {
            // Act & Assert
            expect(() => new MistralEmbedder("")).toThrow("validation.apiKeyRequired");
            expect(() => new MistralEmbedder(null)).toThrow("validation.apiKeyRequired");
            expect(() => new MistralEmbedder(undefined)).toThrow("validation.apiKeyRequired");
        });
    });
