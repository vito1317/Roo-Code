...
describe("VercelAiGatewayEmbedder", () => {
    ...
    describe("constructor", () => {
        it("should create VercelAiGatewayEmbedder with default model", () => {
            ...
            // Assert
            expect(MockedOpenAICompatibleEmbedder).toHaveBeenCalledWith("https://ai-gateway.vercel.sh/v1", apiKey, "openai/text-embedding-3-large", 8191);
        });
        it("should create VercelAiGatewayEmbedder with custom model", () => {
            ...
            // Assert
            expect(MockedOpenAICompatibleEmbedder).toHaveBeenCalledWith("https://ai-gateway.vercel.sh/v1", apiKey, "openai/text-embedding-3-small", 8191);
        });
    ...
    describe("createEmbeddings", () => {
        ...
        it("should delegate to OpenAICompatibleEmbedder with default model", async () => {
            ...
            // Assert
            expect(mockOpenAICompatibleEmbedder.createEmbeddings).toHaveBeenCalledWith(texts, "openai/text-embedding-3-large");
