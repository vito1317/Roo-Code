...
vitest.mock("../../../../i18n", () => ({
    t: (key, params) => {
        const translations = {
            "embeddings:authenticationFailed": "Failed to create embeddings: Authentication failed. Please check your OpenAI API key.",
    ...
    describe("createEmbeddings", () => {
        ...
        describe("retry logic", () => {
            ...
            it("should not retry on non-rate-limit errors", async () => {
                ...
                await expect(embedder.createEmbeddings(testTexts)).rejects.toThrow("Failed to create embeddings: Authentication failed. Please check your OpenAI API key.");
                expect(mockEmbeddingsCreate).toHaveBeenCalledTimes(1);
        ...
        describe("error handling", () => {
            it("should handle API errors gracefully", async () => {
                ...
                expect(console.error).toHaveBeenCalledWith(expect.stringContaining("OpenAI embedder error"), expect.any(Error));
            });
            ...
            it("should handle string errors", async () => {
                ...
                await expect(embedder.createEmbeddings(testTexts)).rejects.toThrow("Failed to create embeddings after 3 attempts: Something went wrong");
            });
            ...
            it("should handle errors from response.status property", async () => {
                ...
                await expect(embedder.createEmbeddings(testTexts)).rejects.toThrow("Failed to create embeddings after 3 attempts: HTTP 403 - Request failed");
            });
        });
    });
