                ...
                it("should correctly handle OpenRouter mistral model dimensions across restarts", async () => {
                    ...
                    mockedGetModelDimension.mockImplementation((provider, modelId) => {
                        if (provider === "openrouter") {
                            if (modelId === "mistralai/codestral-embed-2505")
                                return 1536;
                            if (modelId === "mistralai/mistral-embed-2312")
                                return 1024;
                            if (modelId === "openai/text-embedding-3-large")
                                return 3072;
                        }
                        return undefined;
                    });
                    ...
                    mockContextProxy.getSecret.mockImplementation((key) => {
                        if (key === "codebaseIndexOpenRouterApiKey")
                ...
                it("should not require restart for OpenRouter when same model dimensions are used", async () => {
                    ...
                    mockedGetModelDimension.mockImplementation((provider, modelId) => {
                        if (provider === "openrouter") {
                            if (modelId === "mistralai/codestral-embed-2505")
                                return 1536;
                            if (modelId === "openai/text-embedding-3-small")
                                return 1536;
                        }
                        return undefined;
                    });
