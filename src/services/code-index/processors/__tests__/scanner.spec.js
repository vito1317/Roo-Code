...
describe("DirectoryScanner", () => {
    ...
    beforeEach(async () => {
        ...
        scanner = new DirectoryScanner(mockEmbedder, mockVectorStore, mockCodeParser, mockCacheManager, mockIgnoreInstance);
    ...
    describe("scanDirectory", () => {
        ...
        it("should parse changed files and return empty codeBlocks array", async () => {
            ...
            const scannerNoEmbeddings = new DirectoryScanner(null, // No embedder
            null, // No vector store
            mockCodeParser, mockCacheManager, mockIgnoreInstance);
            const { listFiles } = await import("../../../glob/list-files");
            vi.mocked(listFiles).mockResolvedValue([["test/file1.js"], false]);
            const mockBlocks = [
                {
