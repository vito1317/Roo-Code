...
import { t } from "../../../i18n";
import { QDRANT_CODE_BLOCK_NAMESPACE, MAX_FILE_SIZE_BYTES, MAX_LIST_FILES_LIMIT_CODE_INDEX, BATCH_SEGMENT_THRESHOLD, MAX_BATCH_RETRIES, INITIAL_RETRY_DELAY_MS, PARSING_CONCURRENCY, BATCH_PROCESSING_CONCURRENCY, MAX_PENDING_BATCHES, } from "../constants";
                    ...
                    try {
                        ...
                        if (onError) {
                            ...
                            onError(error instanceof Error
                                ...
                                : new Error(t("embeddings:scanner.unknownErrorDeletingPoints", {
    ...
    async processBatch(batchBlocks, batchTexts, batchFileInfos, scanWorkspace, onError, onBlocksIndexed) {
        ...
        if (!success && lastError) {
            ...
            if (onError) {
                ...
                onError(new Error(t("embeddings:scanner.failedToProcessBatchWithError", {
