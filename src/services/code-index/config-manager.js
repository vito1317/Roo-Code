...
export class CodeIndexConfigManager {
    ...
    _loadAndSetConfiguration() {
        ...
        const { codebaseIndexEnabled, codebaseIndexQdrantUrl, codebaseIndexEmbedderProvider, codebaseIndexEmbedderBaseUrl, codebaseIndexEmbedderModelId, codebaseIndexSearchMinScore, codebaseIndexSearchMaxResults, } = codebaseIndexConfig;
    ...
    doesConfigChangeRequireRestart(prev) {
        ...
        if (prevOpenAiCompatibleBaseUrl !== currentOpenAiCompatibleBaseUrl ||
