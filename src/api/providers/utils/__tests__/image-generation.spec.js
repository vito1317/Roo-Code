...
describe("generateImageWithImagesApi", () => {
    ...
    describe("image generation (text-to-image)", () => {
        it("should successfully generate an image", async () => {
            ...
            expect(global.fetch).toHaveBeenCalledWith("https://api.example.com/v1/images/generations", expect.objectContaining({
                method: "POST",
    ...
    describe("image editing", () => {
        ...
        it("should handle edit operation errors", async () => {
            ...
            vi.mocked(global.fetch).mockResolvedValue(mockResponse);
            const inputImageDataUrl = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAYAAAAfFcSJAAAADUlEQVR42mNk+M9QDwADhgGAWjR9awAAAABJRU5ErkJggg==";
            const result = await generateImageWithImagesApi({
                baseURL: "https://api.example.com/v1",
                authToken: "test-token",
                model: "gpt-image-1",
...
//# sourceMappingURL=image-generation.spec.js.map