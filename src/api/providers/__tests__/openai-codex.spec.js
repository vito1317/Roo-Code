...
describe("OpenAiCodexHandler.getModel", () => {
    it.each(["gpt-5.1", "gpt-5", "gpt-5.1-codex", "gpt-5-codex", "gpt-5-codex-mini"])("should return specified model when a valid model id is provided: %s", (apiModelId) => {
...
//# sourceMappingURL=openai-codex.spec.js.map