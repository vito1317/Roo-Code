...
describe("MiniMaxHandler", () => {
    ...
    beforeEach(() => {
        ...
        const anthropicInstance = Anthropic();
    ...
    describe("China MiniMax", () => {
        ...
        it("should use the correct China MiniMax base URL", () => {
            ...
            expect(Anthropic).toHaveBeenCalledWith(expect.objectContaining({ baseURL: "https://api.minimaxi.com/anthropic" }));
        });
...
//# sourceMappingURL=minimax.spec.js.map