...
import { internationalZAiDefaultModelId, mainlandZAiDefaultModelId, internationalZAiModels, mainlandZAiModels, ZAI_DEFAULT_TEMPERATURE, } from "@roo-code/types";
...
describe("ZAiHandler", () => {
    ...
    describe("China Z AI", () => {
        ...
        it("should use the correct China Z AI base URL", () => {
            ...
            expect(OpenAI).toHaveBeenCalledWith(expect.objectContaining({ baseURL: "https://open.bigmodel.cn/api/coding/paas/v4" }));
        });
