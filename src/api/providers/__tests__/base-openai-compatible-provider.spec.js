...
describe("BaseOpenAiCompatibleProvider", () => {
    ...
    describe("TagMatcher reasoning tags", () => {
        ...
        it("should handle incomplete <think> tag at end of stream", async () => {
            ...
            expect(chunks.length).toBeGreaterThan(0);
            expect(chunks.some((c) => (c.type === "text" || c.type === "reasoning") && c.text.includes("Incomplete thought"))).toBe(true);
        });
...
//# sourceMappingURL=base-openai-compatible-provider.spec.js.map