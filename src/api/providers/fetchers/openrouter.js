...
import { z } from "zod";
import { isModelParameter, OPEN_ROUTER_REASONING_BUDGET_MODELS, OPEN_ROUTER_REQUIRED_REASONING_BUDGET_MODELS, anthropicModels, } from "@roo-code/types";
 ...
 */
export const parseOpenRouterModel = ({ id, model, inputModality, outputModality, maxTokens, supportedParameters, }) => {
