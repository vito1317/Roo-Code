...
const getCacheKey = (router, modelId) => sanitize(`${router}_${modelId}`);
...
export const getModelEndpoints = async ({ router, modelId, endpoint, }) => {
...
export const flushModelProviders = async (router, modelId) => memoryCache.del(getCacheKey(router, modelId));
