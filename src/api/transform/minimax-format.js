 ...
 */
export function mergeEnvironmentDetailsForMiniMax(messages) {
    const result = [];
 ...
 */
export function extractEnvironmentDetailsForMiniMax(messages) {
...
//# sourceMappingURL=minimax-format.js.map