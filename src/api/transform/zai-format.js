 ...
 */
export function convertToZAiFormat(messages, options) {
    const result = [];
        ...
        if (message.role === "user") {
            ...
            if (Array.isArray(message.content)) {
                ...
                if (textParts.length > 0 || imageParts.length > 0) {
                    ...
                    const shouldMergeIntoToolMessage = options?.mergeToolResultText && toolResults.length > 0 && imageParts.length === 0;
...
//# sourceMappingURL=zai-format.js.map