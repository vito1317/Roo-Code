...
export function convertAnthropicContentToGemini(content, options) {
    ...
    const parts = content.flatMap((block) => {
        ...
        switch (block.type) {
            ...
            case "tool_result": {
                ...
                if (!toolName) {
                    throw new Error(`Unable to find tool name for tool_use_id "${block.tool_use_id}". ` +
...
export function convertAnthropicMessageToGemini(message, options) {
