...
describe("convertToMistralMessages", () => {
    ...
    it("should handle user messages with only tool results", () => {
        ...
        expect(mistralMessages[0].toolCallId).toBe(normalizeMistralToolCallId("weather-123"));
    ...
    it("should handle a conversation with mixed message types", () => {
        ...
        expect(mistralMessages[2].toolCallId).toBe(normalizeMistralToolCallId("search-123"));
