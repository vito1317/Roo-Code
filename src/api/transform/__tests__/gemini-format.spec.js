...
describe("convertAnthropicMessageToGemini", () => {
    ...
    it("should throw error when toolIdToName map is not provided", () => {
        ...
        expect(() => convertAnthropicMessageToGemini(anthropicMessage)).toThrow('Unable to find tool name for tool_use_id "calculator-123"');
    });
    it("should throw error when tool_use_id is not in the map", () => {
        ...
        expect(() => convertAnthropicMessageToGemini(anthropicMessage, { toolIdToName })).toThrow('Unable to find tool name for tool_use_id "calculator-123"');
    });
