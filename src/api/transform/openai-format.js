 ...
 * @see https://github.com/cline/cline/issues/8214
 */
export function sanitizeGeminiMessages(messages, modelId) {
...
export function convertToOpenAiMessages(anthropicMessages, options) {
    ...
    for (const anthropicMessage of anthropicMessages) {
         ...
         */
            if (anthropicMessage.role === "user") {
                ...
                const filteredNonToolMessages = nonToolMessages.filter((part) => part.type === "image" || (part.type === "text" && part.text));
