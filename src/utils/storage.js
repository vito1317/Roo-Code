 ...
 */
export async function getStorageBasePath(defaultPath) {
 ...
 */
export async function getTaskDirectoryPath(globalStoragePath, taskId) {
 ...
 */
export async function getSettingsDirectoryPath(globalStoragePath) {
    const basePath = await getStorageBasePath(globalStoragePath);
 ...
 */
export async function getCacheDirectoryPath(globalStoragePath) {
    const basePath = await getStorageBasePath(globalStoragePath);
 ...
 */
export async function promptForCustomStoragePath() {
        ...
        try {
            ...
            if (result) {
                try {
                    ...
                    vscode.window.showErrorMessage(t("common:errors.cannot_access_path", {
                        path: result,
