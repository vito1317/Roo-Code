 ...
 */
export function createOutputChannelLogger(outputChannel) {
    return (...args) => {
        for (const arg of args) {
            if (arg === null) {
                ...
                try {
                    outputChannel.appendLine(JSON.stringify(arg, (key, value) => {
 ...
 */
export function createDualLogger(outputChannelLog) {
    return (...args) => {
