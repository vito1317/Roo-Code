import { sanitizeMcpName, buildMcpToolName, parseMcpToolName, decodeMcpName, normalizeMcpToolName, isMcpTool, MCP_TOOL_SEPARATOR, MCP_TOOL_PREFIX, HYPHEN_ENCODING, } from "../mcp-name";
describe("mcp-name utilities", () => {
    ...
    describe("sanitizeMcpName", () => {
        ...
        it("should remove dots and colons for AWS Bedrock compatibility", () => {
            ...
            expect(sanitizeMcpName("awslabs.aws-documentation-mcp-server")).toBe("awslabsaws___documentation___mcp___server");
        });
    ...
    describe("normalizeMcpToolName", () => {
        ...
        it("should preserve triple underscores (encoded hyphens) while normalizing separators", () => {
            ...
            expect(normalizeMcpToolName("mcp__onellm__atlassian___jira_search")).toBe("mcp--onellm--atlassian___jira_search");
        });
        it("should handle multiple encoded hyphens", () => {
...
//# sourceMappingURL=mcp-name.spec.js.map