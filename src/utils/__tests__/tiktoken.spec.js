            ...
            const largeContent = [
                {
                    type: "tool_result",
                    tool_use_id: "tool_2",
                    content: "This is a much longer result that contains a lot more text and should therefore have a significantly higher token count than the small content.",
                },
            ];
