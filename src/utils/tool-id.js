 ...
 */
export function truncateOpenAiCallId(id, maxLength = OPENAI_CALL_ID_MAX_LENGTH) {
 ...
 */
export function sanitizeOpenAiCallId(id, maxLength = OPENAI_CALL_ID_MAX_LENGTH) {
