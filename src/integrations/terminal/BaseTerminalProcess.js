...
export class BaseTerminalProcess extends EventEmitter {
    ...
    static isCompiling(data) {
        return (BaseTerminalProcess.compilingMarkers.some((marker) => data.toLowerCase().includes(marker.toLowerCase())) &&
            !BaseTerminalProcess.compilingMarkerNullifiers.some((nullifier) => data.toLowerCase().includes(nullifier.toLowerCase())));
    }
}
