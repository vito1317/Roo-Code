    ...
    runCommand(command, callbacks) {
        ...
        const promise = new Promise((resolve, reject) => {
            ...
            pWaitFor(() => this.terminal.shellIntegration !== undefined, {
                ...
                ShellIntegrationManager.zshCleanupTmpDir(this.id);
                process.emit("no_shell_integration", `Shell integration initialization sequence '\\x1b]633;A' was not received within ${Terminal.getShellIntegrationTimeout() / 1000}s. Shell integration has been disabled for this terminal instance. Increase the timeout in the settings if necessary.`);
            });
        });
