 ...
 */
export function readLines(filepath, endLine, startLine) {
    return new Promise((resolve, reject) => {
        ...
        if (endLine !== undefined && effectiveStartLine > endLine) {
            return reject(new RangeError(`startLine (${effectiveStartLine}) must be less than or equal to endLine (${endLine})`));
        }
        // Set up stream
...
//# sourceMappingURL=read-lines.js.map