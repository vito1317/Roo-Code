import { addLineNumbers, everyLineHasLineNumbers, stripLineNumbers, truncateOutput, applyRunLengthEncoding, processCarriageReturns, processBackspaces, } from "../extract-text";
...
describe("applyRunLengthEncoding", () => {
    it("should handle empty input", () => {
        ...
        expect(applyRunLengthEncoding(null)).toBe(null);
        expect(applyRunLengthEncoding(undefined)).toBe(undefined);
    });
...
describe("processCarriageReturns", () => {
    ...
    it("should handle complex tqdm-like progress bars", () => {
        const input = "10%|██        | 10/100 [00:01<00:09, 10.00it/s]\r20%|████      | 20/100 [00:02<00:08, 10.00it/s]\r100%|██████████| 100/100 [00:10<00:00, 10.00it/s]";
...
//# sourceMappingURL=extract-text.spec.js.map