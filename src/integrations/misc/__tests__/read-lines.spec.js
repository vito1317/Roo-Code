...
describe("nthline", () => {
    ...
    describe("readLines function", () => {
        ...
        it("should throw error for negative to_line", async () => {
            await expect(readLines(testFile, -3)).rejects.toThrow("startLine (0) must be less than or equal to endLine (-3)");
        });
        ...
        it("should throw error when from_line > to_line", async () => {
            await expect(readLines(testFile, 1, 3)).rejects.toThrow("startLine (3) must be less than or equal to endLine (1)");
        });
...
//# sourceMappingURL=read-lines.spec.js.map