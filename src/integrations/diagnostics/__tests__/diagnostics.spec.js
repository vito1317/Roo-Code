...
describe("diagnosticsToProblemsString", () => {
    ...
    it("should filter diagnostics by severity and include correct labels", async () => {
        ...
        const result = await diagnosticsToProblemsString([[fileUri, diagnostics]], [vscode.DiagnosticSeverity.Error, vscode.DiagnosticSeverity.Warning], "/path/to");
    ...
    it("should handle directory URIs correctly without attempting to open as document", async () => {
        ...
        const diagnostic = new vscode.Diagnostic(new vscode.Range(0, 0, 0, 10), "Directory diagnostic message", vscode.DiagnosticSeverity.Error);
        ...
        // Call the function
        const result = await diagnosticsToProblemsString([[dirUri, [diagnostic]]], [vscode.DiagnosticSeverity.Error], "/path/to");
    ...
    it("should correctly handle multiple diagnostics for the same file", async () => {
        ...
        const diagnostics = [
            ...
            new vscode.Diagnostic(new vscode.Range(0, 0, 0, 10), "First line warning", vscode.DiagnosticSeverity.Warning),
            new vscode.Diagnostic(new vscode.Range(2, 0, 2, 10), "Middle line info", vscode.DiagnosticSeverity.Information),
        ];
        // Mock fs.stat to return file type
        const mockStat = {
            type: vscode.FileType.File,
        ...
        const result = await diagnosticsToProblemsString([[fileUri, diagnostics]], [vscode.DiagnosticSeverity.Error, vscode.DiagnosticSeverity.Warning, vscode.DiagnosticSeverity.Information], "/path/to");
    ...
    it("should correctly handle diagnostics from multiple files", async () => {
        ...
        ], [vscode.DiagnosticSeverity.Error, vscode.DiagnosticSeverity.Warning, vscode.DiagnosticSeverity.Information], "/path/to");
    ...
    it("should return empty string when no diagnostics match the severity filter", async () => {
        ...
        const result = await diagnosticsToProblemsString([[fileUri, diagnostics]], [vscode.DiagnosticSeverity.Information, vscode.DiagnosticSeverity.Hint], "/path/to");
    ...
    it("should correctly handle cwd parameter for relative file paths", async () => {
        ...
        const diagnostic = new vscode.Diagnostic(new vscode.Range(4, 0, 4, 10), "Relative path test error", vscode.DiagnosticSeverity.Error);
        // Mock fs.stat to return file type
        const mockStat = {
            type: vscode.FileType.File,
        };
        ...
        const result = await diagnosticsToProblemsString([[fileUri, [diagnostic]]], [vscode.DiagnosticSeverity.Error], "/project/root");
        // Verify exact output format
    ...
    it("should return empty string when includeDiagnostics is false", async () => {
        ...
        const result = await diagnosticsToProblemsString([[fileUri, diagnostics]], [vscode.DiagnosticSeverity.Error, vscode.DiagnosticSeverity.Warning], "/path/to", false);
        // Verify empty string is returned
        expect(result).toBe("");
    ...
    it("should limit diagnostics based on count when maxDiagnostics is specified", async () => {
        ...
        const result = await diagnosticsToProblemsString([[fileUri, diagnostics]], [vscode.DiagnosticSeverity.Error, vscode.DiagnosticSeverity.Warning], "/path/to", true, // includeDiagnostics
        3);
    ...
    it("should prioritize errors over warnings when limiting diagnostics by count", async () => {
        ...
        const diagnostics2 = [
            ...
            new vscode.Diagnostic(new vscode.Range(2, 0, 2, 10), "Info in file2", vscode.DiagnosticSeverity.Information),
        ];
        // Mock fs.stat to return file type
        const mockStat = {
            type: vscode.FileType.File,
        ...
        const result = await diagnosticsToProblemsString([
            [fileUri1, diagnostics1],
            [fileUri2, diagnostics2],
        ], [vscode.DiagnosticSeverity.Error, vscode.DiagnosticSeverity.Warning, vscode.DiagnosticSeverity.Information], "/path/to", true, // includeDiagnostics
        2);
