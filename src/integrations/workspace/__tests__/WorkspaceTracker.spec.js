...
describe("WorkspaceTracker", () => {
    ...
    it("should handle workspace path changes when tabs change", async () => {
        ...
        listFiles.mockResolvedValue(mockFiles);
        getWorkspacePath.mockReturnValue("/test/new-workspace");
    ...
    it("should not update file paths if workspace changes during initialization", async () => {
        ...
        listFiles.mockImplementation(() => {
            ...
            ;
            getWorkspacePath.mockReturnValue("/test/changed-workspace");
    ...
    it("should handle dispose with active resetTimer", async () => {
        expect(registeredTabChangeCallback).not.toBeNull();
        getWorkspacePath.mockReturnValueOnce("/test/workspace").mockReturnValueOnce("/test/new-workspace");
        // Trigger resetTimer
        await registeredTabChangeCallback();
...
//# sourceMappingURL=WorkspaceTracker.spec.js.map