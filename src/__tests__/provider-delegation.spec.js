...
describe("ClineProvider.delegateParentAndOpenChild()", () => {
    it("persists parent delegation metadata and emits TaskDelegated", async () => {
        ...
        const parentTask = { taskId: "parent-1", emit: vi.fn() };
        ...
        const getTaskWithId = vi.fn().mockImplementation(async (id) => {
            if (id === "parent-1") {
                return {
                    historyItem: {
                        id: "parent-1",
        ...
        const child = await ClineProvider.prototype.delegateParentAndOpenChild.call(provider, params);
        ...
        expect(parentSaved).toEqual(expect.objectContaining({
            id: "parent-1",
            status: "delegated",
...
//# sourceMappingURL=provider-delegation.spec.js.map